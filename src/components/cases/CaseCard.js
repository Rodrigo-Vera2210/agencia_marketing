    ...
    return (
        ...
        >
            <div className="flex-shrink-0">
                <img
                    id={data.id}
                    className="h-96 w-full transition duration-400 object-cover"
                    src={data.imageUrl}
                    alt=""
                />
            </div>
            <div className="flex flex-1 flex-col justify-between bg-white p-6">
                <div className="flex-1">
                    ...
                    <a href={data.href} className="mt-2 block">
                        <p id={index} className="lg:text-4xl pt-4 pb-6 text-2xl font-semibold transition duration-400 text-gray-900">
                            {data.title}
                        </p>
                        <p className="mt-3 lg:text-2xl text-xl space-y-2 leading-9 text-gray-500">
                            {data.description}
                        </p>
                    </a>
                </div>
