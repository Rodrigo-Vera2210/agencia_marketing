...
function Header() {
    return (
        <main>
            <div className="relative px-6 lg:px-8 pb-16">
                <div className="mx-auto max-w-full mx-12 xl:pt-40 xl:pb-64 lg:pt-56 lg:pb-48 pt-24 pb-12">
                    <div>
                        <div>
                            ...
                            <p className="mt-6 text-2xl leading-8 text-black">
                                ...
                                Reiciendis iure mollitia suscipit ut minus.
                            </p>
                        </div>
