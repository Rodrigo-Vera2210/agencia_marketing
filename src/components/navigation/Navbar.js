...
function Navbar() {
    ...
    return (
        <nav
            id="navbar"
            className="w-full py-6 top-0 transition duration-300 easy-in-out z-40 fixed"
        >
            <div className="px-4 sm:px-6">
                <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                    ...
                    <div className="ml-4 mt-2 flex-shrink-0">
                        ...
                        <Link
                            to="/contacto"
                            className="inline-flex items-center rounded-md border border-transparent bg-orange-btn px-6 py-2 text-lg font-medium text-white shadow-sm transition duration-300 easy-in-out hover:bg-black focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
                        >
                            Hire us
                            <DotLoader
